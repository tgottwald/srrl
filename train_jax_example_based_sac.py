...
from src.ExampleBasedSAC import ExampleBasedSAC
...
@hydra.main(version_base=None, config_path="cfg", config_name="example_based_sac.yaml")
def main(cfg: DictConfig) -> None:
    ...
    algo = ExampleBasedSAC(cfg, env, eval_env)
